En la pantalla que muestras estás editando el archivo README.md en GitHub. Este archivo sirve para describir tu proyecto y se muestra automáticamente en la página principal del repositorio.
